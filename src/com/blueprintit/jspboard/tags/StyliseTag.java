...
public class StyliseTag extends BodyTagSupport
{
	...
	private String applySmiley(String smiley, String line, String img)
	{
	...
	private String applySmilies(String line)
	{
	...
	private String doUBBC(String full)
	{
	...
	private String styleFull(String full)
	{
		return doUBBC(full);
	}
	...
	public int doAfterBody()
	{
		try
		{
			BufferedReader in = new BufferedReader(new StringReader(styleFull(getBodyContent().getString())));
